    ...
    return (
        ...
        >
            {isEditing ? (
                ...
                >
                    <input
                        value={title}
                        className={
                            "pl-2 pr-2 [&:not(:focus)]:bg-[--bg-secondary] [&:not(:focus)]:text-[--foreground] focus:outline-0 focus:border-[--border-primary] focus:border border rounded border-[--border-primary] active:bg-[--bg-secondary] focus:bg-[--bg-secondary] active:text-[--foreground] focus:text-[--foreground]"
                        }
            ...
            <textarea
                ...
                className={
                    "w-full rounded p-3 bg-[--bg-secondary] text-[--foreground]"
                }
            />
        </div>
    );
