...
function ExperienceEditor({ data, setResumeContent }: ExperienceEditorProps) {
    ...
    return (
        <div
            className={
                "bg-[--background] border border-[--border-primary] rounded p-2 flex flex-col gap-2"
            }
        >
            <>
                {isEditing ? (
                    <h2
                        className={
                            "text-lg font-semibold text-[--foreground] flex flex-row items-center gap-2"
                        }
                    >
                        <input
                            value={title}
                            className={
                                "w-1/2 pl-2 pr-2 [&:not(:focus)]:bg-[--bg-secondary] [&:not(:focus)]:text-[--foreground] focus:outline-0 focus:border-[--background] focus:border-2 border-2 rounded border-[--border-primary] active:bg-[--bg-secondary] focus:bg-[--bg-secondary] active:text-[--foreground] focus:text-[--foreground]"
                            }
                    ...
                    <h2
                        className={
                            "text-lg font-semibold flex flex-row items-center gap-2 text-[--foreground]"
                        }
                    >
                        <p>{data.title}</p>
                        <button
            ...
            <div className={"flex flex-col gap-2"}>
                {data.entries.map((experience, i) => (
                    ...
                    >
                        <div
                            ...
                            className={
                                "flex flex-col md:flex-row gap-2 justify-between text-[--foreground] p-2"
                            }
                        >
                            <p>
                            ...
                            <div
                                className={
                                    "flex flex-row justify-between text-[--foreground] gap-2"
                                }
                            >
                                <button
                                    onClick={() =>
                                ...
                                <button onClick={() => handleEntryDelete(i)}>
                        ...
                        {accordionControls[i] && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <input
                                        className={
                                            "w-full rounded p-2 bg-[--bg-secondary] text-[--foreground]"
                                        }
                                    ...
                                    <div
                                        className={
                                            "grid grid-rows-2 md:grid-cols-2 gap-2"
                                        }
                                    >
                                        <div>
                                            <label
                                        ...
                                        >
                                            ...
                                            >
                                                <input
                                                    ...
                                                    name={"start-date"}
                                                    className={
                                                        "border border-[--border-primary] rounded p-2 bg-[--bg-secondary] text-[--foreground]"
                                                    }
                                                    value={constructDate(
                                    ...
                                    <textarea
                                        ...
                                        className={
                                            "border border-[--border-primary] w-full rounded p-2 bg-[--bg-secondary] text-[--foreground]"
                                        }
                                    />
                                    <label
                                        className={
                                    ...
                                    >
                                        ...
                                        <span className={"text-sm"}>
                                            (leave a single empty line between
                                            entries for bullets)
                                        </span>
                                    </label>
                                    <textarea
                                        ...
                                        className={
                                            "border border-[--border-primary] w-full field-sizing-content rounded p-2 bg-[--bg-secondary] text-[--foreground]"
                                        }
                                    />
                                    <label
                                        className={
                                    ...
                                    <div className={"flex flex-row gap-2"}>
                                        ...
                                        <input
                                            ...
                                            className={
                                                "w-fit pl-2 pr-2 [&:not(:focus)]:bg-[--bg-secondary] [&:not(:focus)]:text-[--foreground] focus:outline-0 focus:border-[--background] focus:border-2 border-2 rounded border-[--border-primary] active:bg-[--bg-secondary] focus:bg-[--bg-secondary] active:text-[--foreground] focus:text-[--foreground]"
                                            }
                                            onChange={(e) => {
                                                JsonUtils.update(
                                                    data,
                ...
                <button
                    className={
                        "w-full text-[--foreground] border rounded border-[--border-primary] p-2 flex justify-center"
                    }
